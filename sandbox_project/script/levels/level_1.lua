...
Level.assets = { [0] =
  { type = "texture", name = assets.tile, file = "./sandbox_project/assets/tilemaps/jungle.png" },
  { type = "texture", name = assets.chopper, file = "./sandbox_project/assets/images/chopper-spritesheet.png" },
  { type = "texture", name = assets.tank, file = "./sandbox_project/assets/images/tank-tiger-up.png" },
  { type = "texture", name = assets.bullet, file = "./sandbox_project/assets/images/bullet.png" },
  { type = "font", name = assets.font, file = "./sandbox_project/assets/fonts/pico8.ttf" },
}

-- Map

Level.map = {
  path = "./sandbox_project/assets/tilemaps/jungle.map",
...
Level.game_objects[0] = {
  ...
  components = {
    ...
    script = {
      path = "./sandbox_project/script/script.lua";
    }
  }
}


Level.game_objects[1] = {
  name = "tank",
  alliances = { "enemies" },
